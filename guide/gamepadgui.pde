...
public interface GamepadGUIConst {
...
public class GamepadGUI implements GamepadGUIConst {
  ...
  protected float previewAlpha = 128;
  ...
  GamepadGUI(PApplet app, String xmlName) {
